      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            ...
            Sereni AI fosters natural, stress-free conversations.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Intelligent companion</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Sereni AI is your intelligent companion, offering real-time conversations, emotional support, 
              and interactions,understands your feelings. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Sereni AI Insights</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Gain valuable insights into user interactions with Sereni AI through detailed engagement metrics, 
              conversation patterns, emotional trends. 
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Visibility &amp;Speed</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Gain deep insights into how users interact with Sereni AI through detailed engagement analytics, 
              conversation flow tracking, emotional response patterns
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
